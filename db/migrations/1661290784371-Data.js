module.exports = class Data1661290784371 {
  name = 'Data1661290784371'

  async up(db) {
    await db.query(`CREATE TABLE "substrate_council_proposal" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "last_update" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_id" integer, "proposal_index" integer, "proposal_hash" text NOT NULL, "pallet" text, "method" text, "status" text NOT NULL, "aye_count" integer NOT NULL, "nay_count" integer NOT NULL, "threshold" integer NOT NULL, "account_id" character varying, CONSTRAINT "PK_de7e32a4bd91872e2de07fc2626" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_15ad9e7c37a6ed0a9a6767ab27" ON "substrate_council_proposal" ("account_id") `)
    await db.query(`CREATE INDEX "IDX_5b6eb93fad2207264e747015e6" ON "substrate_council_proposal" ("public_key") `)
    ...
    await db.query(`CREATE TABLE "substrate_council_vote" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_index" integer NOT NULL, "approve" boolean NOT NULL, "account_id" character varying, "proposal_id" character varying, CONSTRAINT "PK_1f1048f82fd8ea3f80453b0cd35" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_858957db11f91f86c9adda9114" ON "substrate_council_vote" ("account_id") `)
    await db.query(`CREATE INDEX "IDX_73460f46698d5cfcc2144ef9dc" ON "substrate_council_vote" ("public_key") `)
    ...
    await db.query(`CREATE TABLE "substrate_proposal_vote" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "ref_index" integer NOT NULL, "vote" text NOT NULL, "account_id" character varying, CONSTRAINT "PK_7eda9706266bf01ed47b51d0257" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_17e4cf681684ff09db454426be" ON "substrate_proposal_vote" ("account_id") `)
    await db.query(`CREATE INDEX "IDX_732aac9d2e7faa50e3caebfc85" ON "substrate_proposal_vote" ("public_key") `)
    await db.query(`CREATE INDEX "IDX_7773c2d4378b43742527e9a7c1" ON "substrate_proposal_vote" ("ref_index") `)
    await db.query(`CREATE TABLE "substrate_democracy_preimage" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "block_number" numeric NOT NULL, "section" text NOT NULL, "method" text NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "balance" numeric NOT NULL, "account_id" character varying, CONSTRAINT "PK_36fb062a653c63424458d14c0b6" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_7cd4050030611ed01e9e23e1ea" ON "substrate_democracy_preimage" ("account_id") `)
    await db.query(`CREATE TABLE "substrate_democracy_proposal_second" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "upper_bound" integer, "account_id" character varying, "proposal_id" character varying, CONSTRAINT "PK_819dd811b3f4d630ea6b9aab429" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_9dd24e507f451ee9555f57e5ac" ON "substrate_democracy_proposal_second" ("account_id") `)
    await db.query(`CREATE INDEX "IDX_1689c4bf6cd9285d48c5507334" ON "substrate_democracy_proposal_second" ("public_key") `)
    await db.query(`CREATE INDEX "IDX_7ddb816aaed8bc69d4afe8b0fb" ON "substrate_democracy_proposal_second" ("proposal_id") `)
    await db.query(`CREATE TABLE "substrate_democracy_proposal" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_hash" text NOT NULL, "proposal_index" integer NOT NULL, "title" text, "description" text, "deposit_amount" numeric NOT NULL, "status" character varying(9) NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "tabled_at_block" numeric, "account_id" character varying, "preimage_id" character varying, "democracy_referenda_id" character varying, CONSTRAINT "PK_1ace727c2511fe1ea57ec7db260" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_388f3fd3b03fa4f0b699b77916" ON "substrate_democracy_proposal" ("account_id") `)
    await db.query(`CREATE INDEX "IDX_58be4f3454d965ec59aa57fdaa" ON "substrate_democracy_proposal" ("public_key") `)
    ...
    await db.query(`CREATE INDEX "IDX_2c28727ddc0694688007cc6a69" ON "substrate_democracy_proposal" ("preimage_id") `)
    ...
    await db.query(`CREATE TABLE "substrate_democracy_referenda_vote" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "aye" numeric NOT NULL, "nay" numeric NOT NULL, "account_id" character varying, "democracy_referenda_id" character varying, CONSTRAINT "PK_eeb367ade1bf48c659f03ac9213" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_357dd82aa1eae21f256a49e511" ON "substrate_democracy_referenda_vote" ("account_id") `)
    await db.query(`CREATE INDEX "IDX_d720d898fdcbbb5784fdea9f00" ON "substrate_democracy_referenda_vote" ("public_key") `)
    await db.query(`CREATE INDEX "IDX_4f21c172412765f4236b9328dc" ON "substrate_democracy_referenda_vote" ("democracy_referenda_id") `)
    await db.query(`CREATE TABLE "substrate_technical_committee_proposal" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_index" integer NOT NULL, "proposal_hash" text NOT NULL, "threshold" integer NOT NULL, "account_id" character varying, CONSTRAINT "PK_a000e763ae0db4818898edc82ba" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_64fc814aab90131e9c8cea6e5e" ON "substrate_technical_committee_proposal" ("account_id") `)
    await db.query(`CREATE INDEX "IDX_8e9085210d2dd6e03e2232bb53" ON "substrate_technical_committee_proposal" ("public_key") `)
    await db.query(`CREATE INDEX "IDX_126d98f91611ab3bad97b05f8a" ON "substrate_technical_committee_proposal" ("proposal_index") `)
    await db.query(`CREATE TABLE "substrate_election_vote" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "candidates" text array NOT NULL, "amount" numeric NOT NULL, "account_id" character varying, CONSTRAINT "PK_08102bd051fcdc0b97ec12d6877" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_4418e8a14729709867e599ef70" ON "substrate_election_vote" ("account_id") `)
    await db.query(`CREATE INDEX "IDX_3a427423f411fe1c5980ec7350" ON "substrate_election_vote" ("public_key") `)
    await db.query(`CREATE TABLE "substrate_bounty_proposal" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_index" integer NOT NULL, "description" text, "value" numeric, "account_id" character varying, CONSTRAINT "PK_6533aca0649f7230117a2a3b442" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_e543be8d9d4362e014e0fe6d1e" ON "substrate_bounty_proposal" ("account_id") `)
    await db.query(`CREATE INDEX "IDX_90f0869a596df99ff0d734b159" ON "substrate_bounty_proposal" ("public_key") `)
    await db.query(`CREATE INDEX "IDX_0d20305509e3fd71d70a48e9ad" ON "substrate_bounty_proposal" ("proposal_index") `)
    await db.query(`CREATE TABLE "substrate_treasury_proposal" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "title" text, "description" text, "proposal_index" integer NOT NULL, "status" character varying(8), "council_motion_date" TIMESTAMP WITH TIME ZONE, "beneficiary" text, "value" numeric NOT NULL, "account_id" character varying, "beneficiary_account_id" character varying, CONSTRAINT "PK_663a95e6e70180cc40ceb859711" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_b0f3c2115eea9355b7cae7ea15" ON "substrate_treasury_proposal" ("account_id") `)
    await db.query(`CREATE INDEX "IDX_74635de7a14cb97e3813d2e08e" ON "substrate_treasury_proposal" ("public_key") `)
    ...
    await db.query(`CREATE TABLE "substrate_phragmen_election_member_term" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "is_current_term" boolean NOT NULL, "backing" numeric NOT NULL, "account_id" character varying, CONSTRAINT "PK_f273a1699e0227cea1881239e4f" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_60df05ef208a0a0a4cbfff0023" ON "substrate_phragmen_election_member_term" ("is_current_term") `)
    await db.query(`CREATE INDEX "IDX_682e4ede13a7ecfad82d55678f" ON "substrate_phragmen_election_member_term" ("account_id") `)
    await db.query(`CREATE TABLE "substrate_governance_account" ("id" character varying NOT NULL, "public_key" text NOT NULL, "network" character varying(8) NOT NULL, "total_proposal_seconds" integer NOT NULL, "total_democracy_proposal_seconds" integer NOT NULL, "total_proposal_votes" integer NOT NULL, "total_democracy_referenda_votes" integer NOT NULL, "total_election_votes" integer NOT NULL, "total_democracy_proposals" integer NOT NULL, "total_council_proposals" integer NOT NULL, "total_technical_committee_proposals" integer NOT NULL, "total_bounty_proposals" integer NOT NULL, "total_treasury_spend_proposals" integer NOT NULL, CONSTRAINT "PK_ccd1f23a87828f4ee8eb38e9fb7" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_4893389857c75fc0626b1a59e4" ON "substrate_governance_account" ("public_key") `)
    ...
    await db.query(`ALTER TABLE "substrate_democracy_preimage" ADD CONSTRAINT "FK_7cd4050030611ed01e9e23e1ea3" FOREIGN KEY ("account_id") REFERENCES "substrate_governance_account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await db.query(`ALTER TABLE "substrate_democracy_proposal" ADD CONSTRAINT "FK_2c28727ddc0694688007cc6a690" FOREIGN KEY ("preimage_id") REFERENCES "substrate_democracy_preimage"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await db.query(`ALTER TABLE "substrate_democracy_referenda_vote" ADD CONSTRAINT "FK_357dd82aa1eae21f256a49e5117" FOREIGN KEY ("account_id") REFERENCES "substrate_governance_account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "substrate_democracy_referenda_vote" ADD CONSTRAINT "FK_4f21c172412765f4236b9328dcf" FOREIGN KEY ("democracy_referenda_id") REFERENCES "substrate_democracy_referenda"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await db.query(`ALTER TABLE "substrate_phragmen_election_member_term" ADD CONSTRAINT "FK_682e4ede13a7ecfad82d55678f6" FOREIGN KEY ("account_id") REFERENCES "substrate_governance_account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  }

  async down(db) {
    await db.query(`DROP TABLE "substrate_council_proposal"`)
    await db.query(`DROP INDEX "public"."IDX_15ad9e7c37a6ed0a9a6767ab27"`)
    await db.query(`DROP INDEX "public"."IDX_5b6eb93fad2207264e747015e6"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_73460f46698d5cfcc2144ef9dc"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_732aac9d2e7faa50e3caebfc85"`)
    await db.query(`DROP INDEX "public"."IDX_7773c2d4378b43742527e9a7c1"`)
    await db.query(`DROP TABLE "substrate_democracy_preimage"`)
    await db.query(`DROP INDEX "public"."IDX_7cd4050030611ed01e9e23e1ea"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_1689c4bf6cd9285d48c5507334"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_58be4f3454d965ec59aa57fdaa"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_2c28727ddc0694688007cc6a69"`)
    ...
    await db.query(`DROP TABLE "substrate_democracy_referenda_vote"`)
    await db.query(`DROP INDEX "public"."IDX_357dd82aa1eae21f256a49e511"`)
    await db.query(`DROP INDEX "public"."IDX_d720d898fdcbbb5784fdea9f00"`)
    await db.query(`DROP INDEX "public"."IDX_4f21c172412765f4236b9328dc"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_8e9085210d2dd6e03e2232bb53"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_3a427423f411fe1c5980ec7350"`)
    await db.query(`DROP TABLE "substrate_bounty_proposal"`)
    await db.query(`DROP INDEX "public"."IDX_e543be8d9d4362e014e0fe6d1e"`)
    await db.query(`DROP INDEX "public"."IDX_90f0869a596df99ff0d734b159"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_74635de7a14cb97e3813d2e08e"`)
    ...
    await db.query(`DROP TABLE "substrate_phragmen_election_member_term"`)
    await db.query(`DROP INDEX "public"."IDX_60df05ef208a0a0a4cbfff0023"`)
    await db.query(`DROP INDEX "public"."IDX_682e4ede13a7ecfad82d55678f"`)
    await db.query(`DROP TABLE "substrate_governance_account"`)
    await db.query(`DROP INDEX "public"."IDX_4893389857c75fc0626b1a59e4"`)
    ...
    await db.query(`ALTER TABLE "substrate_democracy_preimage" DROP CONSTRAINT "FK_7cd4050030611ed01e9e23e1ea3"`)
    ...
    await db.query(`ALTER TABLE "substrate_democracy_proposal" DROP CONSTRAINT "FK_2c28727ddc0694688007cc6a690"`)
    ...
    await db.query(`ALTER TABLE "substrate_democracy_referenda_vote" DROP CONSTRAINT "FK_357dd82aa1eae21f256a49e5117"`)
    await db.query(`ALTER TABLE "substrate_democracy_referenda_vote" DROP CONSTRAINT "FK_4f21c172412765f4236b9328dcf"`)
    ...
    await db.query(`ALTER TABLE "substrate_phragmen_election_member_term" DROP CONSTRAINT "FK_682e4ede13a7ecfad82d55678f6"`)
  }
}
